        ...
        return [
            {
                ...
                'id': self.env.user.company_id.printnode_printer.id,
                'name': self.env.user.company_id.printnode_printer.name,
            },
            {
                'label': _('Default Company Shipping Label Printer'),
                'id': self.env.user.company_id.company_label_printer.id,
                'name': self.env.user.company_id.company_label_printer.name,
            },
            {
                'label': _('Default Company Scales'),
                'id': self.env.user.company_id.printnode_scales.id,
                'name': self.env.user.company_id.printnode_scales.name,
            },
        ]
