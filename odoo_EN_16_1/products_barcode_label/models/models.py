...
#         return self.env.ref('products_barcode_label.product_product_rep').report_action(self, data=datas)
#     
#     
#     
#     
...
#         return self.env.ref('products_barcode_label.product_template_rep').report_action(self, data=datas)
